...
class handler(requestsManager.asyncRequestHandler):
	...
	def asyncPost(self):
		...
		try:
			...
			userUtils.incrementMapPlaycount(userID, s.scoreID)
			...
			if beatmapInfo is not None and beatmapInfo != False and s.passed:
				...
				if UsingRelax:
					if beatmapInfo.rankedStatus == rankedStatuses.PENDING:
						announceMsg = "[RELAX] (UNRANKED) [https://osu.aipserver.ru/?u={} {}] achieved rank #1 on [https://osu.ppy.sh/b/{} {}] ({})".format(
									userID,
						...
						announceMsg = "[RELAX] [https://osu.aipserver.ru/?u={} {}] achieved rank #1 on [https://osu.ppy.sh/b/{} {}] ({})".format(
									userID,
									username.encode().decode("ASCII", "ignore"),
									beatmapInfo.beatmapID,
									beatmapInfo.songName.encode().decode("ASCII", "ignore"),
					...
					if beatmapInfo.rankedStatus == rankedStatuses.PENDING:
						announceMsg = "[VANILLA] (UNRANKED) [https://osu.aipserver.ru/?u={} {}] achieved rank #1 on [https://osu.ppy.sh/b/{} {}] ({})".format(
									userID,
									username.encode().decode("ASCII", "ignore"),
									beatmapInfo.beatmapID,
									beatmapInfo.songName.encode().decode("ASCII", "ignore"),
						...
						announceMsg = "[VANILLA] [https://osu.aipserver.ru/?u={} {}] achieved rank #1 on [https://osu.ppy.sh/b/{} {}] ({})".format(
									userID,
									username.encode().decode("ASCII", "ignore"),
									beatmapInfo.beatmapID,
									beatmapInfo.songName.encode().decode("ASCII", "ignore"),
